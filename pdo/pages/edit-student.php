              ...
              <form action="" method="post" enctype="multipart/form-data">
                <?php foreach ($student as $st): ?>
              	...
              	<div class="form-group">
              		...
              		<input type="date" class="form-control" name="birthdate"value="<?php echo $st['birthdate'] ?>" required>
              	</div>
              	<!--  -->
              	<div class="form-group">
                  ...
                  if (!empty($_FILES['photo']['name'])) {
                    ...
                    $photo = null;
              	    ...
              	    if (updateStudent($id, $names, $birthdate, $email, $photo, $conn)) {
              	    	$_SESSION['message'] = "El estudiante $names se modificó con éxito!";
              	    	echo "<script>
              	    		setTimeout(function() {
