					...
					<?php if ($_FILES['foto']['error'] > 0): ?>
						...
						<?php else: ?>
							...
							<div class="alert alert-success">
								<strong>El Archivo se ha Subido con Exito!</strong>
								<li><?php echo $_FILES['foto']['name'] ?></li>
								<li><?php echo $_FILES['foto']['type'] ?></li>
								<li><?php echo round($_FILES['foto']['size'] / 1024)?>KB</li>
							</div>
					<?php endif ?>
				<?php endif ?>
			</div>
