		...
		<div class="col-md-6 offset-md-3">
			...
			<form action="" method="post">
				...
				<div class="form-goup">
					...
					<input class="form-control-range" type="range" name="strength" min="0" max="2000" step="5" value="<?php echo $row['strength'] ?>" oninput="ostrength.value=this.value" value="0" required>
					<output id="ostrength" class="badge badge-dark"></output>
				</div>
				<div class="form-goup">
					<label for="stamina">Resistencia</label>
					<input class="form-control-range" type="range" name="stamina" min="0" max="2000" step="5" value="<?php echo $row['stamina'] ?>" oninput="ostamina.value=this.value" value="0" required>
					<output id="ostamina" class="badge badge-dark"></output>
				</div>
				<div class="form-goup">
					<label for="speed">Velocidad</label>
					<input class="form-control-range" type="range" name="speed" min="0" max="2000" step="5" value="<?php echo $row['speed'] ?>" oninput="ospeed.value=this.value" value="0" required>
					<output id="ospeed" class="badge badge-dark"></output>
				</div>
				<div class="form-goup">
					<label for="accuracy">Precision</label>
					<input class="form-control-range" type="range" name="accuracy" min="0" max="2000" step="5" value="<?php echo $row['accuracy'] ?>"  oninput="oaccuracy.value=this.value" value="0" required>
			...
			<?php 
				...
				if ($_POST) {
					...
					if (mysqli_query($con,$sql)) {
						$_SESSION['message'] = "El Pokemon: ".$name. " fue editado con éxito!";
